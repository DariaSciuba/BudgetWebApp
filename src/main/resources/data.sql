...
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-01-15',6,2000.00,'salary',1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-02-15',6,1000.00,'salary',1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-03-15',6,1500.75,'salary',1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-01-30',7,15.50,null,1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-02-04',3,1000.00,'January bonus',1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-03-05',3,1500.75,'February bonus',1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-02-28',7,20.20,null,1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-01-15',7,100.00,'bonus1',1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-01-15',7,200.00,'bonus2',1);
INSERT INTO incomes(date, subcategory_id, amount, note, account_id) VALUES ('2020-01-15',7,300.00,'bonus3',1);
